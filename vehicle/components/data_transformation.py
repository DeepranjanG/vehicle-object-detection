...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        ...
        try:
            ...
            train_dataset = VehicleDetection(root=self.data_transformation_config.ROOT_DIR,split=self.data_transformation_config.TRAIN_SPLIT, transforms=self.get_transforms(True))
